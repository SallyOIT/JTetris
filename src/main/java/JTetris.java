...
public class JTetris extends JComponent {
    ...
    public static final int TOP_SPACE = 8;
	...
	*/
    ...
    public static JFrame createFrame(JTetris tetris) {
        final JFrame frame = new JFrame("Stanford Tetris");
        ...
        frame.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                int flag = JOptionPane.showConfirmDialog(frame, "Sure to close?",
